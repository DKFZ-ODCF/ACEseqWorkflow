...
source(paste0("/home/kleinhei/R_lib/qq.R"))
source(paste0("/home/kleinhei/R_lib/getopt.R"))
...
getopt2(matrix(c('segmentfile',      'f', 1, "character", "comb_pro_extra_file",
		 ...
		 'ploidy',	     'p', 1, "integer", "full ploidy extracted form header of most important info file",
		 'purity',	     'u', 1, "numeric", "purity extracted form header of most important info file",
                 'id',               'i', 1, "character", "patient identifier", 
...
out.data <- data.frame( id, fractionAberrant, fractionGain, fractionLoss, fractionLossLOH, numberHRDSmooth, numberHRD, numberHomoDel,"\t", LST, numberHRDLoss, "\n")
