    ...
    #last segment in chromosome
      ...
      #segment is only adjacent to prior segment or more similar to prior segment with regards to coverage
           ...
           segAll$map[i-1]!="homozygousDel" &&
				...
				cat(paste0("",segAll$chromosome[i], "-",segAll$start[i], ": segment start not eq crest point and tcnMean differnence to former segment < to next segment -> attached to former segment\n\n"))
      ...
      #segment is only adjacent to following segment or more similar to following segment with regards to coverage  
				...
				cat(paste0("",segAll$chromosome[i], "-",segAll$start[i], ": segment start not eq crest point and tcnMean differnence to former segment > to next segment -> attached to next segment\n\n"))
				...
				cat(paste0("",segAll$chromosome[i], "-",segAll$start[i], ": segment has crest point -> not attached\n\n"))
				next
