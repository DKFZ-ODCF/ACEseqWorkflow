...
for newline in infile:
	if int(newline["start"])-int(line["end"]) <= 2  and line["chromosome"] == newline["chromosome"] and line[ "cluster" ] == newline[ "cluster" ] and line["cluster"] != "NA": # or (line["genotype"] ==newline["genotype"] and line["genotype"] != NA) ):
