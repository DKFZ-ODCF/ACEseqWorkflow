...
public final class ACEseqConstants {
    ...
    public static final String TOOL_IMPUTE_GENOTYPES = "phaseGenotypes";
    public static final String TOOL_IMPUTE_GENOTYPES_NOMPILEUP = "phaseGenotypes_noMpileup";
    public static final String TOOL_IMPUTE_GENOTYPEX = "phaseGenotypes_X";
    public static final String TOOL_IMPUTE_GENOTYPEX_NOMPILEUP = "phaseGenotypes_X_noMpileup";
